# Page Lock Plugin for Kirby CMS End User License Agreement
This End User License Agreement (the "Agreement") is a binding legal agreement between you and Pedro Borges (the "Author"). By installing or using the Page Lock Plugin for Kirby CMS (the "Software"), you agree to be bound by the terms of this Agreement. If you do not agree to the Agreement, do not download, install, or use the Software. Installation or use of the Software signifies that you have read, understood, and agreed to be bound by the Agreement.
...
## Technical Support
Technical support is provided on <https://github.com/pedroborges/kirby-pagelock/issues>. No representations or guarantees are made regarding the response time in which support questions are answered.
...
An "Update" of the Software is defined as that which adds any functionality enhancements or any bug fix to all future versions.

The assignment to the category of Update shall be at the sole discretion of the Author.
